...
?>
  <div class="card">
            <div class="card-body">
              <h1 class="grid_title">Dish Management</h1>
                  ...
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
						...
						$i=1;
						while($row=mysqli_fetch_assoc($res)){   //Query to find dish detail
						?>
						<tr>
                            <td><?php echo $i?></td>
                            <td><?php echo $row['category']?></td>
							<td><?php echo $row['dish']?> (<?php echo strtoupper($row['type'])?>)</td>
							<td><a target="_blank" href="<?php echo $row['image']?>"><img src="<?php echo $row['image']?>"/></a></td>
							<td>
							<?php 
